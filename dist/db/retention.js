...
async function createMonthPartition(year, month) {
    ...
    await pool.query(`CREATE TABLE IF NOT EXISTS ${name} PARTITION OF logs
...
export function startRetentionJob() {
    ...
    console.log(`[retention] started — every ${env.RETENTION_INTERVAL_MINUTES}m, retention ${env.RETENTION_DAYS}d`);
}
